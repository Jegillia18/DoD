...
set = [1:3,8,10,11,16:19,22:24,28:30,35:37,42,45,48:52,54,55,59,60,62,64,73,76,77,80];
for i = 1:length(set)
...
Outcome_Variables = [Elbow_variables_all,Wrist_variables_all];             % Stores all the outcome variables from each funcion in a new variable.
