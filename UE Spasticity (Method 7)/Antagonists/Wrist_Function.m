...
s=1;                                                                       % This variable corresponds to the session (pre=1, post=2, follow=3). Change the number depending on the session you are analyzing.
...
WristFl_Name = WristFl_Name{6};                                            % Stores the desired data as a variable. Change number depending on muscle.
